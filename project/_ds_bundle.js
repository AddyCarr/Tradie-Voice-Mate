/* @ds-bundle: {"format":3,"namespace":"TradieVoiceMateDesignSystem_9e482f","components":[{"name":"Card","sourcePath":"components/content/Card.jsx"},{"name":"FeatureColumn","sourcePath":"components/content/FeatureColumn.jsx"},{"name":"StarRating","sourcePath":"components/content/StarRating.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Eyebrow","sourcePath":"components/core/Eyebrow.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"},{"name":"Tick","sourcePath":"components/core/Tick.jsx"},{"name":"SMSNotification","sourcePath":"components/widget/SMSNotification.jsx"},{"name":"TranscriptBubble","sourcePath":"components/widget/TranscriptBubble.jsx"}],"sourceHashes":{"assets/app.js":"f4fd13c107cc","assets/lucide.min.js":"41c1c5a9d97e","components/content/Card.jsx":"3e6ee1b74270","components/content/FeatureColumn.jsx":"de54a0f6941a","components/content/StarRating.jsx":"45de90ade88e","components/core/Button.jsx":"fa129443d90c","components/core/Eyebrow.jsx":"87a0135064d7","components/core/Tag.jsx":"3bc7e7fa8fa7","components/core/Tick.jsx":"e797aac0bfe9","components/widget/SMSNotification.jsx":"00759e794214","components/widget/TranscriptBubble.jsx":"545f83e70f3d","ui_kits/marketing-site/site.js":"d8d3fdce1c9c"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.TradieVoiceMateDesignSystem_9e482f = window.TradieVoiceMateDesignSystem_9e482f || {});
...
(function () {
  function init() {
    ...
    /* ---- Social proof ticker ---- */
    var quotes = [['Pays for itself the first week.', 'Reliable Plumbing Co., QLD'], ['It handled 6 calls on Saturday while I was flat out on a job. Legends.', 'Premium Pest Control, NSW'], ['My guys thought it was a real person answering.', 'Hillside Tree Loppers, VIC'], ['Set up in 10 minutes. Works perfectly.', 'A.J. Contractors, WA']];
    function starSVG() {
    ...
    if (!reduceMotion && window.innerWidth > 760) {
      ...
      // far background grid — slow
      {
        sel: '.hero-people',
        base: 'translateY(-85%)',
        amp: -34
      },
      // receptionist image, behind widget
      {
        sel: '#widget',
        base: '',
        amp: 14
      },
      // foreground widget, opposite drift
      {
        sel: '.int-people',
        base: 'translateX(-50%)',
        amp: -32
      },
      // team image, behind CRM mockup
      {
        sel: '.booked-ui',
        base: 'translateX(-50%)',
        amp: 14
      ...
      window.addEventListener('scroll', pxMeasure, {
        passive: true
      });
    ...
    var lines = [{
      at: 1,
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Hi, you've reached Tall Timber Tree Services on a recorded line. I'm their digital receptionist — the team's busy, but I'll take your details to pass on. Can I grab your first name?"
    }, {
      at: 11,
      who: 'caller',
      label: 'Caller',
      text: "Yeah, my name's John. I've got a red gum leaning over the house — I need it taken down ASAP."
    }, {
      at: 17,
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Thanks John. So that's a red gum leaning over the house, removed ASAP. What's the postcode for the job?"
    }, {
      at: 24,
      who: 'caller',
      label: 'Caller',
      ...
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Great, that's 3144 — is that right?"
    }, {
      at: 27.5,
      who: 'caller',
      label: 'Caller',
      ...
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Is the number you're calling on the best one to reach you?"
    }, {
      at: 32,
      who: 'caller',
      label: 'Caller',
      text: "Nah, give me a buzz back on 0437 414 424."
    }, {
      at: 38,
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Perfect, I've got 0437 414 424 — is that correct?"
    }, {
      at: 42,
      who: 'caller',
      label: 'Caller',
      ...
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Thanks John. Is there a preferred time for the team to call you back?"
    }, {
      at: 48,
      who: 'caller',
      label: 'Caller',
      text: "Next Thursday after about 5pm would be fantastic."
    }, {
      at: 52,
      who: 'agent',
      label: 'Digital Receptionist',
      text: "No worries — red gum removal leaning near the house in 3144, and we'll call you next Thursday around 5pm. Sound good?"
    }, {
      at: 63,
      who: 'caller',
      label: 'Caller',
      ...
      who: 'agent',
      label: 'Digital Receptionist',
      text: "Beauty — the team will be in touch next Thursday around 5pm. Have a good one."
    }];
    var pills = [{
      at: 13,
      label: 'Name · John'
      ...
      at: 25.5,
      label: 'Job · Red gum removal'
    }, {
      at: 26,
      label: 'Postcode · 3144'
    }, {
      at: 39,
      label: 'Phone · 0437 414 424'
    }, {
      at: 50,
      label: 'Callback · Thu ~5pm'
    }];
    ...
    function tick() {
      ...
      for (var i = 0; i < lines.length; i++) {
        if (t >= lines[i].at) idx = i;
      }
      if (idx !== -1 && idx !== shownLine) {
        shownLine = idx;
        showLine(idx);
      }
    ...
    function pauseFlow() {
      ...
      if (audioMode && audio) {
        ...
        pausedElapsed = (Date.now() - startWall) / 1000;
      }
    ...
    function resumeFlow() {
      ...
      if (audioMode && audio) {
        ...
        startWall = Date.now() - pausedElapsed * 1000;
      }
      statusEl.textContent = 'Live call example';
      statusEl.style.color = 'var(--tvm-forest-green)';
      clearInterval(pollId);
    ...
    if (ctrlBtn) ctrlBtn.addEventListener('click', function (e) {
      ...
      if (state === 'pause') pauseFlow();else if (state === 'play') resumeFlow();else if (state === 'restart') {
        reset();
        startCall();
      }
    });
    ...
    widget.addEventListener('click', function (e) {
      ...
      if (widget.classList.contains('ended')) {
        reset();
        startCall();
      }
    });
...
(function (a, n) {
  ...
  const n = {
    ...
    nA = (...t) => t.filter((h, d, c) => !!h && h.trim() !== "" && c.indexOf(h) === d).join(" ").trim(),
    lA = t => t.replace(/^([A-Z])|[\s-_]+(\w)/g, (h, d, c) => c ? c.toUpperCase() : d.toLowerCase()),
    eA = t => {
      const h = lA(t);
...
lucide.createIcons({icons});\``);
    ...
    if (Array.from(c.querySelectorAll(`[${h}]`)).forEach(p => za(p, {
      ...
      icons: t,
      attrs: d
    })), M && Array.from(c.querySelectorAll("template")).forEach(p => cA({
      icons: t,
      nameAttr: h,
      attrs: d,
      root: p.content,
      ...
      p.length > 0 && (console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"), Array.from(p).forEach(La => za(La, {
        nameAttr: "icon-name",
        icons: t,
        attrs: d
      })));
...
// components/content/FeatureColumn.jsx
try { (() => {
/**
...
Object.assign(__ds_scope, { FeatureColumn });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/content/FeatureColumn.jsx", error: String((e && e.message) || e) }); }
...
// components/widget/SMSNotification.jsx
try { (() => {
/**
...
function SMSNotification({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: "26px",
      borderRadius: "7px",
      background: "var(--tvm-forest-green)",
      display: "grid",
      placeItems: "center",
      flexShrink: 0
    }
  ...
  }, "New lead \u2014 ", business), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "12px",
      color: "var(--tvm-on-light-45)"
    }
    ...
    style: {
      ...
      color: f.accent ? "var(--tvm-forest-green)" : "var(--tvm-near-black)"
    }
  }, f.value)))));
}
Object.assign(__ds_scope, { SMSNotification });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/widget/SMSNotification.jsx", error: String((e && e.message) || e) }); }

// components/widget/TranscriptBubble.jsx
try { (() => {
/**
...
Object.assign(__ds_scope, { TranscriptBubble });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/widget/TranscriptBubble.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  function init() {
    ...
    /* ---- Social proof ticker ---- */
    var quotes = [['Pays for itself the first week.', 'Plumber, QLD'], ['It handled 6 calls on Saturday while I was flat out on a job. Legends.', 'Pest Control, NSW'], ['My guys thought it was a real person answering.', 'Arborist, VIC'], ['Set up in 10 minutes. Works perfectly.', 'Building Contractor, WA']];
    function starSVG() {
      return '<span class="stars">' + Array(5).fill('<svg width="15" height="15" viewBox="0 0 24 24" fill="#fff"><path d="M12 2l2.9 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14l-5-4.87 7.1-1.01L12 2z"/></svg>').join('') + '</span>';
    }
    var ticker = document.getElementById('ticker');
...
__ds_ns.SMSNotification = __ds_scope.SMSNotification;

__ds_ns.TranscriptBubble = __ds_scope.TranscriptBubble;
